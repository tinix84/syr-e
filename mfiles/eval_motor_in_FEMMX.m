...
function [out,FemmProblem] = eval_motor_in_FEMMX(FemmProblem,geo,io,gamma_in,eval_type,boundnameAPmove)
...
kk = 1;
[SOL(:,:,kk), FemmProblem] = simulate_xdegX(FemmProblem,geo,nsim,delta_sim,io,gamma(kk),eval_type,boundnameAPmove); % risultati
