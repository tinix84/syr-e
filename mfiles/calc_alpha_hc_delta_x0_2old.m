...
function geo = calc_alpha_hc_delta_x0(geo)
...
geo.Ar = Ar;                                    % superiore dell'ultima barriera possa avere inizio, al limite, in corrispondenza della linea di 
...
hc_half_min = 0.5*pont0;                                                                % Spessore minimo barriera di flusso
...
if (nlay==1)
        hc_half_max = (alpha*pi/180/(1+alpha*pi/180)*(xr-pont0)); %%26 Jan 2011
