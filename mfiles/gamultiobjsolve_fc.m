...
%   $Revision: 1.1.6.1 $  $Date: 2007/05/23 18:51:09 $
...
if ~isempty(options.HybridFcn)
    if strcmpi(options.PopulationType,'doubleVector')
        ...
        warning('gads:gamultiobjsolve:notValidHybrid','''HybridFcn'' can only be used with ''doubleVector'' population; ignoring ''HybridFcn'' option');
    end
end
