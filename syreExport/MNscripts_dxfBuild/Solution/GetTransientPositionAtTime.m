function x = GetTransientPositionAtTime(magData,ID,t,motionComponent)
...
invoke(mh,'processCommand',['Val(0)=getDocument().getSolution().getPositionOfMotionComponent(sol,',motionComponent,')']);
