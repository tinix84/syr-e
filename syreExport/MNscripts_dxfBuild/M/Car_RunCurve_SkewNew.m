...
temp4 = [FilePath,FileName(1:end-14) 'CaseBackup' SLASH temp3]
...
for kk = 1:size(Sim.Id_,1)
    ...
    for k = 1:size(Sim.Id_,2)
        ...
        for kkk = 1:Sim.skew_Nstep
            ...
            if (kkk == 1)
                CaseFileName = [temp4 SLASH Mac.MachineName '_' temp1 '_' temp2 '.mn'];
            else
                temp6 = num2str(kkk);
                CaseFileName = [temp4 SLASH Mac.MachineName '_' temp1 '_' temp2 '_' temp6 '.mn'];
            end
...
%                 % valori medi
%                 F_map.Fd(kk,k,kkk) = Fluxd_0;
%                 F_map.Fq(kk,k,kkk) = Fluxq_0;
%                 F_map.T(kk,k,kkk) = Torque_0;
            end
            % Append data mean (Fd Fq map)
